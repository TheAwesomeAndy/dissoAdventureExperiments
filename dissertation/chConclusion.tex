...
Third, the \textbf{measurement-instrument framing} (Chapter~\ref{chap:dynamics}) treats a fixed reservoir as an inspectable computational transform rather than a black-box feature generator. The present work defines and audits named response summaries, but it does not establish physical calibration, prove the Echo State Property for all bounded inputs, or validate patient-level reliability.
