...
The mean coupling scalar at three-class is $\kappa = 0.221 \pm 0.111$, with the permutation test producing $p = 0.000$ ($0/5{,}000$ null realizations exceed the observed value). Coupling is unambiguously real at both granularities (Figure~\ref{fig:ch7_3class_coupling}).
...
\begin{figure}[H]
    ...
    \caption{Coupling existence at three-class resolution ($N = 211$, $633$ observations). Left: group-mean $7 \times 2$ coupling matrix showing mixed positive/negative pattern ($6/14$ negative, $8/14$ positive), contrasting with the uniformly negative four-class result. Right: permutation test ($5{,}000$ shuffles). Observed $\kappa = 0.221$ exceeds every null realization ($p = 0.000$).}
