...
|----|------------------------------------------------------------|-----------------------------------------------------------------------------------------|---------|-----------------------------------------------------------------------------------------------------------------------------------|--------------------|
| 1  | "The contraction measurement, visualized"                  | Defense audit: autonomous $\rho(W)$ vs.\ driven $\lambda_1$                              | main    | Reservoir-contraction region. Replaces the field-default ESN-stability citation with a driven Lyapunov measurement on the 3,165-trial strict clean-ERP subset of the chDynamics 4,220 Lyapunov pool; both populations 100\% stable. Slide explicitly reconciles the two $N$ counts. | 90 s               |
...
| 3  | "Defense audit: autonomous $\rho(W)$ vs.\ driven $\lambda_1$" (insertion #1) | Defense audit: memory-capacity regime for leak $\beta$                                  | main    | Reservoir/LIF region. Leak $\beta = e^{-\Delta t/\tau_m}$ was introduced earlier in the LIF block; the MC operating characteristic defends $\beta$ as a measured hyperparameter on the reservoir side, not as a graph-side knob. **Moved from after "The propagation operator" per defense-audit feedback** — MC is a reservoir property, irrelevant to graph propagation. Sits immediately after insertion #1 to group both "audit-the-reservoir" frames. | 90 s               |
