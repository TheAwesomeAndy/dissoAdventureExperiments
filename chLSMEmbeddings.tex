...
These profile-level correlations show that the BSC$_6$ temporal pattern corresponds to conventional ERP summaries. The strongest comparison is with Late Positive Potential amplitude, an established measure of sustained affective processing \cite{nelson_hajcak_2017}, with $|r| = 0.82$ ($r^2 = 0.67$). This is evidence of aggregate temporal correspondence; it does not establish patient-level recovery or clinical utility.
