...
\begin{frame}{Defense audit: autonomous $\rho(W)$ vs.\ driven $\lambda_1$}
  \begin{columns}[T]
    ...
    \begin{column}{0.38\textwidth}\small
      Autonomous spectral radius $\rho(W) = 0.265$ is an undriven
      property of $W$; it does not determine reservoir behavior under
      real ERP drive. Stability is a measured property of the
      ...
      \begin{itemize}\small
        \item Driven $\lambda_1$ via Benettin on $3{,}165$ real ERP
              trajectories.
        \item Audit cohort ($N{=}3{,}165$) is the strict clean-ERP
              subset of the $N{=}4{,}220$ Lyapunov pool from
              chDynamics; both populations $100\%$ stable.
